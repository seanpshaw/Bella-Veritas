...
<head>
  ...
  <link type="text/css" href="/<?php echo path_to_theme(); ?>/js/jquery.jscrollpane.css" rel="stylesheet" media="all" />
  <!-- the mousewheel plugin -->
  <script type="text/javascript" src="/<?php echo path_to_theme(); ?>/js/jquery.mousewheel.js"></script>
  <!-- the jScrollPane script -->
  <script type="text/javascript" src="/<?php echo path_to_theme(); ?>/js/jquery.jscrollpane.min.js"></script>
        ...
        <?php print $content_top; ?>
         <div id="main" class="clearfix column <?php print ns('grid-16', $sidebar_first, 4, $sidebar_second, 6) . ' ' . ns('push-4', !$sidebar_first, 4); ?>">
          ...
          <div id="content" class="column"><div class="section">
            ...
            <div id="content-area" class="scroll-pane">
              <?php print $content; ?>
            </div>
	  ...
	  <?php if ($footer || $footer_message || $secondary_links || $address_raw || $credits): ?>
	    <div id="footer-wrapper">	
		    ...
		    <div id="footer-bottom" class="container-16 clearfix clear">
		      ...
		      <div id="email"><a href="mailto:info@10secondsmovie.com" title="10 Seconds Email" rel=""><img src="sites/all/themes/tenseconds/images/email-image.png" alt="info@10secondsmovie.com" /></a></div>
