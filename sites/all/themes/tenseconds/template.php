...
function tenseconds_preprocess(&$vars, $hook) {
 ...
 */
function tenseconds_preprocess_page(&$vars, $hook) {
  ...
  $vars['regular_secondary_links'] =  theme(array('links__system_main_menu', 'links'), $vars['secondary_links'],
	...
	if( isset( $_COOKIE['tenseconds_style'] ) )
		$vars['tenseconds_style'] = $_COOKIE['tenseconds_style']; 
	else
		$vars['tenseconds_style'] = theme_get_setting('color_style');
...
// function tenseconds_preprocess_node(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function tenseconds_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function tenseconds_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */

function tenseconds_add_image(&$vars, $name, $presetname, $path ){
...
function tenseconds_change_theme($change, $changeVal, $page=''){
	
	$theme_settings = variable_get('theme_tenseconds_settings', array());
	
	$cookie_prefix = "tenseconds_";
